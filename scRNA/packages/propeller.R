# TODO(dawelsch): !!! WARNING! Ripped from library(speckle) to circumvent
# version issues!
# Original citation from speckle:
# Phipson B, Sim C, Porrello E, Hewitt A, Powell J, Oshlack A (2022).
# “propeller: testing for differences in cell type proportions in single cell
# data.” Bioinformatics, 38(20), -6.
